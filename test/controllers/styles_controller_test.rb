...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference("Style.count") do
      post styles_url, params: { style: { beer_type: @style.beer_type, description: @style.description } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { beer_type: @style.beer_type, description: @style.description } }
